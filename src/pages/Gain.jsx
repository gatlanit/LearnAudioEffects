  ...
  return (
    <main className="main_content">
      ...
      <p>
        ...
        Think of it like a volume knob that controls how loud something gets before it moves through the rest of your audio chain.
      </p>

      <p>
        Give it a try below! Drag the sphere in and out to change the gain amount. As you expand it, the amount of gain increases making it louder; shrinking it, on the otherhand, decreases the gain amount making it quieter.
      </p>
